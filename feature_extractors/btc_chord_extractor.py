...
class BTCChordExtractor(FeatureExtractor):
    ...
    def extract_features(self, audio_path):
        ...
        feature = numpy.pad(feature, ((0, num_pad), (0, 0)), mode="constant", constant_values=0)
        ...
        with torch.no_grad():
            ...
            self.features["prediction"] = numpy.array([])
            for t in range(num_instance):
                ...
                self.features["prediction"] = numpy.concatenate([self.features["prediction"], prediction.cpu()])
